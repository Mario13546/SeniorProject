...
class Signing:
    def __init__(self) -> None:
        ...
        self.position = np.zeros(26).tolist()
    ...
    def initPositions(self):
        ...
        self.position[5]  = np.array([000, 000, 180, 180, 180, 90.], dtype = np.float32)  # F
        self.position[6]  = np.array([000, 180, 000, 000, 000, 90.], dtype = np.float32)  # G
        ...
        self.position[14] = np.array([000, 000, 000, 000, 000, 000], dtype = np.float32)  # O
        ...
        self.position[23] = np.array([000, 90., 000, 000, 000, 180], dtype = np.float32)  # X
        ...
        print("Signs available for b, d, e, f, i, l, o, s, t, v, w, x, and y." )
